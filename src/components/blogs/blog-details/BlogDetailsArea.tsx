...
const content_data: ContentData = {
   ...
   desc_9: (<>The Worldstreet team brings decades of combined experience in financial markets, technology, and trading education to help traders succeed globally.</>),
