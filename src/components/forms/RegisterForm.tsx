...
const RegisterForm = ({ style }: any) => {
   ...
   const onSubmit = (data: FormData) => {
      const notify = () => toast('Account created successfully! Welcome to Worldstreet.', { position: 'top-center' });
      notify();
      reset();
   };
         ...
         <div className="eg-login__input-wrapper">
            ...
            <div className="eg-login__input-box">
               <div className="eg-login__input">
                  ...
                  <input id="email" {...register("email")} type="email" placeholder="trader@worldstreet.app" />
