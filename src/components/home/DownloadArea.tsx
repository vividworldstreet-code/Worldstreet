                  ...
                  <div className="col-lg-6">
                     <div className="download-content">
                        <div className="section-title mb-40">
                           <h2 className="title">Trade on the Go with Our Mobile Apps</h2>
                        </div>
                        <div className="download-list">
                           <ul className="list-wrap">
                              <li><span>1</span>Real-time market data & alerts</li>
                              <li><span>2</span>One-tap trading & portfolio management</li>
                           </ul>
                        </div>
