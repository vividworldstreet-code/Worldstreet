...
const contact_data: DataType[] = [
   {
      ...
      title: "Location",
      info: (<>Worldstreet Global HQ <br /> Lagos, Nigeria</>),
   },
   {
      id: 2,
      icon: "fas fa-phone-alt",
      title: "Contact",
      info: (<><Link href="tel:+2348000000000">+234 800 WORLDST</Link> <br /> <Link href="tel:+2348000000000">+234 800 000 0000</Link></>),
   },
   {
      id: 3,
      icon: "fas fa-envelope",
      title: "Email",
      info: (<><Link href="mailto:support@worlstreet.com">support@worlstreet.com</Link> <br /> <Link href="mailto:support@worlstreet.com">support@worlstreet.com</Link></>),
   },
   {
      id: 4,
